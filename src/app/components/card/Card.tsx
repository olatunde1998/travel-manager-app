    ...
    <>
      <main className="text-gray-600">
        <div className="max-w-[400px] shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
          ...
          <p className="p-2 bg-[#FBF6EB] font-semibold text-[14px]">Today&apos;s Agenda</p>
          <p></p>
      ...
      <main className="mt-12 md:mt-0  text-gray-600">
        <div className="max-w-[400px] shadow-[0_8px_30px_rgb(0,0,0,0.12)] pb-14">
          ...
          <div className='flex justify-between bg-[#FBF6EB]'>
            <p className="p-2 text-[14px] bg-[#FBF6EB] font-semibold">Activity Report</p>
            <p className='text-[12px] text-[#DDAA33] flex items-center pr-4'>View full activity report <GoArrowRight color="#DDAA33"/></p>
          </div>
          <div className="p-2 text-[14px]">
            ...
            <p className="ml-8 p-1 bg-[#FBF6EB] text-gray-500 border-l-2 border-[#DEAB36] font-semibold text-[12px] w-fit">Status: Pending</p>
          </div>
        </div>
      </main>
    </>
      ...
      <main className="mt-12  text-gray-600">
        <div className="max-w-[400px] shadow-[0_8px_30px_rgb(0,0,0,0.12)] pb-12">
          ...
          <div className='flex justify-between bg-[#FBF6EB]'>
            ...
            <p className='text-[12px] text-[#DDAA33] flex items-center pr-4'>Create Task<GoArrowRight color="#DDAA33" className="ml-4"/></p>
          </div>
          <div className="p-2 md:p-4  bg-[#FBF6EB] text-[12px]  m-6">
